    ...
    <HelmetProvider>
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          {/* Storefront routes */}
          <Route path="/*" element={
            <div className="min-h-screen flex flex-col" style={{ background: "#16080B" }}>
              <Navbar />
        ...
        <Toaster
          ...
          toastOptions={{
            duration: 3000,
            style: {
              background: 'linear-gradient(145deg, #210B10 0%, #2A0D13 100%)',
              color: '#F4EBDD',
            ...
            success: {
              style: {
                background: 'linear-gradient(145deg, #1A2018 0%, #210B10 100%)',
                color: '#D8E8D0',
                border: '1px solid rgba(90, 138, 90, 0.4)',
              },
              iconTheme: { primary: '#5A8A5A', secondary: '#16080B' },
            },
            error: {
              style: {
                background: 'linear-gradient(145deg, #210B10 0%, #2A0D13 100%)',
              ...
              iconTheme: { primary: '#A04048', secondary: '#16080B' },
            },
          }}
        />
      </BrowserRouter>
