...
const COLORS = [
  { label: "Gold", bg: "from-[#292725] to-[#3d1f00]", accent: "#C5963A" },
  ...
  return (
    <div className={`bg-gradient-to-r ${banner.bg} rounded-xl flex items-center justify-between px-4 py-3 gap-3 min-h-[90px]`}>
      <div className="flex-1 min-w-0">
        ...
        <p className="text-[#292725] text-sm font-bold leading-tight">{banner.title || "Title"}</p>
        ...
        {(banner.price || banner.originalPrice) && (
          <div className="flex items-center gap-2 mt-0.5">
            {banner.price && <span className="text-[#292725] text-sm font-bold">₹{banner.price}</span>}
        ...
        <>
          {logoUrl && (
            <div className="flex items-center gap-4 p-3 bg-[#1A0A02] rounded-xl border border-[#3D1F0A]">
              <img src={logoUrl} alt="Logo preview" className="w-16 h-16 rounded-full object-cover border-2 border-[#C5963A]" onError={e => { e.target.style.display = "none" }} />
              <div>
