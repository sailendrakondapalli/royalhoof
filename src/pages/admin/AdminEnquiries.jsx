            ...
            <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
              {types.map(type => (
                <button key={type} onClick={() => setSelectedType(type)} style={{
                  ...
                  color: selectedType === type ? "#16080B" : TEXT_MUTED,
            ...
            <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
              {statuses.map(status => (
                <button key={status} onClick={() => setSelectedStatus(status)} style={{
                  ...
                  color: selectedStatus === status ? "#16080B" : TEXT_MUTED,
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                    ...
                    <div style={{ display: "flex", gap: 8 }}>
                      <button onClick={() => saveNotes(item.id)}
                        style={{ background: ACCENT, color: "#16080B", border: "none", borderRadius: 4, padding: "6px 16px", cursor: "pointer", fontWeight: 600, fontSize: "0.8125rem", fontFamily: "'Inter', sans-serif" }}>
                        Save
                      </button>
                  ...
                  <>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        color: (selectedEvent && events.length > 0 && !isSending) ? "#16080B" : TEXT_MUTED,
                        border: "none",
                        borderRadius: 6,
                        padding: "12px 20px",
                        cursor: (selectedEvent && events.length > 0 && !isSending) ? "pointer" : "not-allowed",
