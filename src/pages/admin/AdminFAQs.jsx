  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-[#292725]">FAQs Management</h1>
        <button
          onClick={() => { setShowForm(true); setEditingItem(null); resetForm() }}
          className="flex items-center gap-2 bg-[#C5963A] text-white px-4 py-2 rounded-lg hover:bg-[#8A6640]"
        >
          <Plus size={20} />
          Add FAQ
        </button>
      ...
      {showForm && (
        <div className="bg-[#FAF3E4] rounded-lg shadow-md p-6 mb-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-3">
              <button
                type="submit"
                className="bg-[#C5963A] text-white px-6 py-2 rounded-lg hover:bg-[#8A6640]"
              >
      ...
      <div className="space-y-6">
        {Object.keys(groupedItems).map(category => (
          <div key={category} className="bg-[#FAF3E4] rounded-lg shadow-md overflow-hidden">
            <div className="bg-gray-50 px-6 py-3 border-b">
              <h3 className="text-lg font-semibold text-[#292725]">{category}</h3>
            </div>
      ...
      {filteredItems.length === 0 && (
        <div className="bg-[#FAF3E4] rounded-lg shadow-md p-12 text-center text-gray-500">
