    ...
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-[#C9A227] text-white px-4 py-2 rounded-lg hover:bg-[#8A6640]"
        >
          <Plus size={20} />
          Add FAQ
        </button>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-3">
              <button
                type="submit"
                className="bg-[#C9A227] text-white px-6 py-2 rounded-lg hover:bg-[#8A6640]"
              >
