                  ...
                  <motion.tr key={c.id} initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
                    ...
                    <td className="px-5 py-3 text-right">
                      <div className="flex items-center justify-end gap-2">
                        <button onClick={() => openEdit(c)} className="text-[#C5963A] hover:text-[#b5824f] p-1"><Pencil size={14} /></button>
                  ...
                  <div className="flex flex-col gap-3 justify-center">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input type="checkbox" checked={form.is_one_time}
                        onChange={e => setForm(f => ({ ...f, is_one_time: e.target.checked }))} className="accent-[#C5963A] w-4 h-4" />
                      <span className="text-sm text-[#292725] font-medium">One-time use per user</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input type="checkbox" checked={form.is_active}
                        onChange={e => setForm(f => ({ ...f, is_active: e.target.checked }))} className="accent-green-500 w-4 h-4" />
                      <span className="text-sm text-[#292725] font-medium">Active (visible to customers)</span>
                    </label>
                  </div>
                </div>
