...
const COLORS = ['#C9A227', '#B9AFA3', '#9A8870', '#7A6A54', '#5A4A38', '#C4B09A', '#E8D8C4', '#F0E8D8']

const TooltipStyle = {
  contentStyle: { background: '#16080B', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 8, fontSize: 11, color: '#F4EBDD' },
...
export default function AdminAnalytics() {
  ...
  if (!stats) {
    return (
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", height: 240 }}>
        <div style={{ width: 32, height: 32, border: "2px solid #C9A227", borderTopColor: "transparent", borderRadius: "50%", animation: "spin 0.7s linear infinite" }} />
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.75rem", fontWeight: 700, color: "#F4EBDD" }}>Analytics</h1>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          <div key={i} style={{ background: "#16080B", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 8, padding: 20 }}>
            <k.icon size={18} style={{ color: "#C9A227", marginBottom: 12 }} />
            <p style={{ fontSize: "1.5rem", fontWeight: 700, color: "#F4EBDD", fontFamily: "'Inter', sans-serif" }}>{k.value}</p>
      ...
      {/* Revenue Area Chart */}
      <div style={{ background: "#16080B", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 8, padding: 20 }}>
        <h3 style={{ color: "#F4EBDD", fontWeight: 600, marginBottom: 16, fontSize: "0.9375rem", fontFamily: "'Inter', sans-serif" }}>Revenue Trend (Last 14 Days)</h3>
        <ResponsiveContainer width="100%" height={260}>
          <AreaChart data={stats.last14Days}>
            ...
            <Area type="monotone" dataKey="revenue" stroke="#C9A227" fill="url(#accentGrad)" strokeWidth={2} name="Revenue" />
          </AreaChart>
        </ResponsiveContainer>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div style={{ background: "#16080B", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 8, padding: 20 }}>
          <h3 style={{ color: "#F4EBDD", fontWeight: 600, marginBottom: 16, fontSize: "0.9375rem", fontFamily: "'Inter', sans-serif" }}>Weekly Orders</h3>
          <ResponsiveContainer width="100%" height={220}>
            <BarChart data={weeklyData}>
              ...
              <Bar dataKey="orders" fill="#C9A227" radius={[4, 4, 0, 0]} name="Orders" />
            </BarChart>
          </ResponsiveContainer>
        </div>

        <div style={{ background: "#16080B", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 8, padding: 20 }}>
          <h3 style={{ color: "#F4EBDD", fontWeight: 600, marginBottom: 16, fontSize: "0.9375rem", fontFamily: "'Inter', sans-serif" }}>Revenue by Category</h3>
          <ResponsiveContainer width="100%" height={220}>
            <PieChart>
      ...
      {/* Location Analytics */}
      <div style={{ background: "#16080B", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 8, padding: 20 }}>
        <h3 style={{ color: "#F4EBDD", fontWeight: 600, marginBottom: 16, fontSize: "0.9375rem", display: "flex", alignItems: "center", gap: 8, fontFamily: "'Inter', sans-serif" }}>
          <MapPin size={15} style={{ color: "#C9A227" }} /> Location Analytics — Top Cities
        </h3>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-3">
            {stats.cityData.map((c, i) => (
              <div key={c.city} style={{ display: "flex", alignItems: "center", gap: 12 }}>
                <span style={{ color: "#C9A227", fontSize: "0.75rem", width: 20, fontWeight: 700 }}>{i + 1}</span>
                <div style={{ flex: 1 }}>
                  <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
                    <span style={{ color: "#F4EBDD", fontSize: "0.75rem" }}>{c.city}</span>
      ...
      {/* Top Products */}
      <div style={{ background: "#16080B", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 8, padding: 20 }}>
        <h3 style={{ color: "#F4EBDD", fontWeight: 600, marginBottom: 16, fontSize: "0.9375rem", fontFamily: "'Inter', sans-serif" }}>Best Selling Products</h3>
        <ResponsiveContainer width="100%" height={240}>
