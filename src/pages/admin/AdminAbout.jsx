    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
      ...
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 16, flexWrap: "wrap" }}>
        ...
        <div style={{ display: "flex", gap: 10 }}>
          ...
          <button onClick={handleSave} disabled={saving}
            style={{ display: "flex", alignItems: "center", gap: 6, background: saving ? "rgba(216,199,174,0.5)" : ACCENT, color: "#16080B", border: "none", borderRadius: 4, padding: "8px 20px", cursor: saving ? "not-allowed" : "pointer", fontWeight: 700, fontSize: "0.8125rem", fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24, alignItems: "start" }} className="about-grid">
        ...
        <div style={{ background: CARD_BG, border: `1px solid ${CARD_BORDER}`, borderRadius: 8, padding: 24, position: "sticky", top: 80 }}>
          ...
          {/* Preview card */}
          <div style={{ background: "#16080B", borderRadius: 8, padding: 20, border: `1px solid rgba(255,255,255,0.05)` }}>
            {/* Eyebrow */}
