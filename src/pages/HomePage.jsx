...
function HeroSlider() {
  ...
  return (
    <section className="relative w-full overflow-hidden" style={{ height: "clamp(500px, 75vh, 720px)" }}>
      {/* Background */}
      <div className="absolute inset-0 bg-[#16080B]" />
      <video 
        autoPlay 
        muted 
        loop 
      ...
      <div className="absolute inset-0" style={{ 
        background: "linear-gradient(to top, rgba(14,5,7,0.92) 0%, rgba(22,8,11,0.45) 45%, rgba(14,5,7,0.2) 100%)" 
      }} />
      {/* Subtle gold vignette */}
      <div className="absolute inset-0 pointer-events-none" style={{
        background: "radial-gradient(ellipse at 50% 80%, rgba(201,162,39,0.06) 0%, transparent 60%)",
      }} />
        ...
        {Array(TOTAL).fill(0).map((_, i) => (
          <button 
            ...
            className={`rounded-full transition-all duration-500 ${
              i === slide 
                ? "w-8 h-1 bg-[#C9A227] shadow-[0_0_8px_rgba(201,162,39,0.4)]" 
                : "w-1.5 h-1.5 bg-[#F4EBDD]/25 hover:bg-[#F4EBDD]/50"
            }`} 
          />
        ))}
      </div>
...
function AboutSection() {
  ...
  return (
    <section className={`w-full py-20 bg-[#16080B] ${PX}`}>
      <ScrollReveal>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-4">
            ...
            <span className="block text-base mt-2 font-medium" style={{ color: "#B9AFA3", fontFamily: "'Inter', sans-serif" }}>
              {d.subtitle}
            </span>
          </div>
              ...
              <div className="grid grid-cols-3 gap-4 mt-6">
                {stats.map((s, i) => (
                  <div key={i} className="text-center py-5 rounded-sm equestrian-card"
                    ...
                    <div className="flex justify-center mb-2" style={{ color: "#C9A227" }}>{s.icon}</div>
                    <p className="font-bold text-base" style={{ color: "#F4EBDD", fontFamily: "'Cormorant Garamond', serif" }}>{s.value}</p>
                    <p className="text-xs mt-1" style={{ color: "#B9AFA3", fontFamily: "'Inter', sans-serif" }}>{s.label}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="w-full space-y-5">
              {[d.p1, d.p2, d.p3, d.p4, d.p5, d.p6].filter(Boolean).map((para, i) => (
                <p key={i} className="leading-relaxed text-base"
                  style={{ color: "#C9A227", fontFamily: "'Inter', sans-serif", lineHeight: "1.8" }}>
                  {para}
                </p>
              ))}
            </div>
  ...
  if (totalSlides === 0) {
    return (
      <div className="text-center py-12">
        <p className="text-[#B9AFA3] text-sm">No upcoming events at the moment</p>
        <p className="text-[#B9AFA3] text-xs mt-2">Check back soon for updates!</p>
      </div>
    )
  }
                ...
                <div className="relative">
                  ...
                  <div className="relative w-full overflow-hidden" style={{ aspectRatio: "16/9" }}>
                    ...
                    <div className="absolute top-6 right-6">
                      <span className="bg-[#C9A227] text-white px-4 py-2 rounded-full text-sm font-medium uppercase tracking-wide">
          ...
          {events.map((_, index) => (
            <button
              ...
              className={`transition-all duration-300 ${
                index === currentSlide 
                  ? "w-8 h-2 bg-[#C9A227] rounded-full" 
                  : "w-2 h-2 bg-[#C9A227]/30 rounded-full hover:bg-[#C9A227]/50"
              }`}
            />
          ))}
        </div>
            ...
            <button
              ...
              className={`relative overflow-hidden rounded-md transition-all duration-300 ${
                index === currentSlide 
                  ...
                  : "hover:ring-1 hover:ring-[#C9A227]/50 hover:scale-102"
              }`}
            >
      ...
      <ScrollReveal>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            {/* Contact Info */}
            <div>
              <h3 className="text-2xl font-bold text-[#F4EBDD] mb-6" style={{ fontFamily: "'Inter', sans-serif" }}>
                <span style={{ color: "#F4EBDD" }}>Have Questions? We're Here to</span> <span style={{ color: "#D8C7A0", fontStyle: "italic" }}>Help!</span>
              </h3>
              <p className="text-[#C9A227] mb-8 leading-relaxed">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[#F4EBDD] font-medium">Call or WhatsApp</p>
                    <p className="text-[#B9AFA3] text-sm">+91 90437 00776</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[#F4EBDD] font-medium">Email Us</p>
                    <p className="text-[#B9AFA3] text-sm">info@royalhoof.com</p>
                  </div>
                </div>
              </div>

              <div className="mt-8 pt-6 border-t border-[#2A0D13]">
                <Link 
                  to="/contact"
                  className="inline-flex items-center gap-2 text-[#C9A227] hover:text-[#8A6640] font-medium transition-colors"
                >
            ...
            <div className="equestrian-card rounded-lg p-8">
              <h4 className="text-xl font-bold text-[#F4EBDD] mb-6" style={{ fontFamily: "'Inter', sans-serif" }}>
                Send Quick Message
              </h4>
              
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label className="block text-[#C9A227] text-sm font-medium mb-2">
                    Name *
                  </label>
                  <input
                    type="text"
                    ...
                    className="w-full bg-[#16080B] border border-[#2A0D13] rounded-lg px-4 py-3 text-[#F4EBDD] placeholder-[#B9AFA3]/50 focus:outline-none focus:border-[#C9A227] transition-colors"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full bg-[#16080B] border border-[#2A0D13] rounded-lg px-4 py-3 text-[#F4EBDD] placeholder-[#B9AFA3]/50 focus:outline-none focus:border-[#C9A227] transition-colors resize-none"
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full bg-[#C9A227] hover:bg-[#8A6640] text-white py-3 rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {submitting ? (
                    <>
...
function EnquiryCTASection() {
  return (
    <section className={`w-full py-20 ${PX}`} style={{ background: "#210B10" }}>
      <ScrollReveal>
        <div className="max-w-4xl mx-auto text-center">
          <h3 className="text-3xl font-bold text-[#F4EBDD] mb-4" style={{ fontFamily: "'Inter', sans-serif" }}>
            <span style={{ color: "#F4EBDD" }}>Ready to Get</span> <span style={{ color: "#D8C7A0", fontStyle: "italic" }}>Started?</span>
          </h3>
          <p className="text-[#C9A227] mb-8 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link
              to="/enquiry"
              className="bg-[#C9A227] hover:bg-[#8A6640] text-white px-8 py-4 rounded-lg font-medium transition-colors flex items-center gap-2"
            >
            ...
            <Link
              to="/contact"
              className="bg-transparent border-2 border-[#C9A227] text-[#C9A227] hover:bg-[#C9A227] hover:text-white px-8 py-4 rounded-lg font-medium transition-colors flex items-center gap-2"
            >
              <Phone size={20} />
              Contact Us
            </Link>
...
function WhyChooseUs({ displayFeatures }) {
  ...
  return (
    <section className={`w-full py-16 ${PX}`} style={{ background: "#16080B", borderTop: "1px solid rgba(182, 165, 143, 0.05)", borderBottom: "1px solid rgba(182, 165, 143, 0.05)" }}>
      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        <div className="grid grid-cols-2 gap-6 md:absolute md:inset-0 md:grid-cols-1 md:pointer-events-none">
          ...
          <div className="flex flex-col items-center text-center gap-3 md:absolute md:top-1/4 md:left-0 lg:left-8 md:transform md:-translate-y-1/2 md:pointer-events-auto">
            <div className="w-16 h-16 rounded-full border border-[#C9A227]/30 flex items-center justify-center text-[#C9A227]"
              style={{ background: "rgba(154, 118, 80, 0.05)" }}>
              {displayFeatures[0].icon}
            </div>
            <div>
              <p className="text-[#F4EBDD] text-xs font-semibold tracking-wider uppercase mb-1" 
                style={{ fontFamily: "'Inter', sans-serif" }}>
                {displayFeatures[0].title}
              </p>
              {displayFeatures[0].sub && <p className="text-[#B9AFA3] text-xs">{displayFeatures[0].sub}</p>}
            </div>
          </div>
          ...
          <div className="flex flex-col items-center text-center gap-3 md:absolute md:top-1/4 md:right-0 lg:right-8 md:transform md:-translate-y-1/2 md:pointer-events-auto">
            ...
            <div>
              ...
              {displayFeatures[1].sub && <p className="text-[#B9AFA3] text-xs">{displayFeatures[1].sub}</p>}
            </div>
          </div>
          ...
          <div className="flex flex-col items-center text-center gap-3 md:absolute md:bottom-1/4 md:left-0 lg:left-8 md:transform md:translate-y-1/2 md:pointer-events-auto">
            ...
            <div>
              ...
              {displayFeatures[2].sub && <p className="text-[#B9AFA3] text-xs">{displayFeatures[2].sub}</p>}
            </div>
          </div>
          ...
          <div className="flex flex-col items-center text-center gap-3 md:absolute md:bottom-1/4 md:right-0 lg:right-8 md:transform md:translate-y-1/2 md:pointer-events-auto">
            ...
            <div>
              ...
              {displayFeatures[3].sub && <p className="text-[#B9AFA3] text-xs">{displayFeatures[3].sub}</p>}
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <Link to="/packages" className="group block">
      <div className="equestrian-card rounded-lg p-6 h-full group-hover:scale-105 transition-transform duration-300">
        <h3 className="text-lg font-bold text-[#F4EBDD] mb-2" style={{ fontFamily: "'Inter', sans-serif" }}>
          {pkg.name}
        </h3>
        <div className="mb-4">
          ...
          <span className="text-[#B9AFA3] text-sm">/{pkg.duration}</span>
        </div>
        {pkg.age_group && (
          <p className="text-[#C9A227] text-sm mb-3 font-medium">{pkg.age_group}</p>
        )}
        {pkg.description && (
          <p className="text-[#C9A227] text-sm mb-4 leading-relaxed line-clamp-2">
            {pkg.description}
          </p>
        )}
...
export default function HomePage() {
  ...
  return (
    <>
      ...
      {/* EVENTS - Lighter */}
      <section id="events" className={`w-full py-20 ${PX}`} style={{ background: "#210B10" }}>
        <ScrollReveal>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {loadingPackages ? Array(6).fill(0).map((_, i) => (
            <div key={i} className="animate-pulse">
              <div className="bg-[#2A0D13] rounded-lg h-48"></div>
            </div>
            ...
            <div className="col-span-full text-center py-12">
              <p className="text-[#B9AFA3] text-lg">No packages available</p>
      ...
      <section className={`w-full py-20 bg-[#16080B] ${PX}`}>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
          {loadingGallery ? Array(6).fill(0).map((_, i) => (
            <div key={i} className="animate-pulse">
              <div className="bg-[#2A0D13] rounded-sm aspect-square"></div>
            </div>
            ...
            <div className="col-span-full text-center py-12">
              <p className="text-[#B9AFA3] text-lg">No gallery items available</p>
              <p className="text-[#B9AFA3] text-sm mt-2">Check back soon for updates!</p>
            </div>
          )}
        </div>
      ...
      {/* REVIEWS - Lighter */}
      <section className="w-full" style={{ background: "#210B10" }}>
