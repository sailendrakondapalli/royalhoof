...
export default function PolicyPage() {
  ...
  if (!policy) {
    return (
      <div style={{ minHeight: "60vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#F4E9D2" }}>
  ...
  return (
    <>
      ...
      <div style={{ background: "#F4E9D2", minHeight: "100vh", padding: "48px 24px 80px" }}>
        <div style={{ maxWidth: 720, margin: "0 auto" }}>

          {/* Page header */}
          <div style={{ marginBottom: 40, paddingBottom: 24, borderBottom: "1px solid rgba(255,255,255,0.07)" }}>
            <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "0.75rem", letterSpacing: "0.25em", textTransform: "uppercase", color: "#C5963A", marginBottom: 10 }}>
              Royal Hoof Horse Riding Academy
            </p>
            <h1 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(1.75rem, 4vw, 2.5rem)", fontWeight: 700, color: "#292725", lineHeight: 1.15 }}>
              {policy.title}
            </h1>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            {policy.sections.map((section, i) => (
              <div key={i} style={{
                ...
                <h2 style={{ color: "#C5963A", fontWeight: 600, fontSize: "1rem", marginBottom: 10, fontFamily: "'Inter', sans-serif" }}>
                  {section.heading}
                </h2>
