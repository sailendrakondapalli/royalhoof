        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h1 className="heading-editorial text-4xl mb-4">
              <span style={{ color: "#F4EBDD" }}>What Our Members</span> <span style={{ color: "#D8C7A0", fontStyle: "italic" }}>Say</span>
            </h1>
            <div className="equestrian-divider w-24 mx-auto mb-6" />
            <p className="text-[#C9A227] max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
            {[
              ...
              <div key={i} className="equestrian-card rounded-lg p-6 text-center">
                <p className="heading-editorial text-3xl mb-2 text-[#C9A227]">{stat.value}</p>
                <p className="text-[#B9AFA3] text-sm uppercase tracking-wider">{stat.label}</p>
              </div>
            ))}
          </div>
          ...
          {loading ? (
              ...
              {[1, 2, 3, 4, 5, 6].map(i => (
                <div key={i} className="equestrian-card rounded-lg p-6 animate-pulse">
                  <div className="flex gap-1 mb-4">
                    {[1, 2, 3, 4, 5].map(j => (
                      <div key={j} className="w-4 h-4 bg-[#2A0D13] rounded-sm" />
                    ))}
                  </div>
                  <div className="space-y-2 mb-6">
                    <div className="h-4 bg-[#2A0D13] rounded" />
                    <div className="h-4 bg-[#2A0D13] rounded w-5/6" />
                    <div className="h-4 bg-[#2A0D13] rounded w-4/6" />
                  </div>
                  <div className="flex items-center gap-3 pt-4 border-t border-[#2A0D13]">
                    <div className="w-12 h-12 bg-[#2A0D13] rounded-full" />
                    <div className="space-y-1">
                      <div className="h-4 bg-[#2A0D13] rounded w-20" />
                      <div className="h-3 bg-[#2A0D13] rounded w-16" />
                    </div>
                  </div>
                </div>
              ))}
            ...
            <div className="text-center py-16">
              <p className="text-[#C9A227] text-lg mb-4">No testimonials available yet.</p>
              <p className="text-[#B9AFA3] text-sm">Check back soon for member reviews!</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
              {testimonials.map(testimonial => (
                <div key={testimonial.id} className="equestrian-card rounded-lg p-6 relative">
                  ...
                  <div className="absolute top-6 right-6 opacity-10">
                    <Quote size={48} className="text-[#C9A227]" />
                  </div>
                  ...
                  {/* Review Text */}
                  <p className="text-[#C9A227] text-sm leading-relaxed mb-6">
                    "{testimonial.review}"
                  </p>
                  ...
                  <div className="flex items-center gap-3 pt-4 border-t border-[#2A0D13]">
                    ...
                    />
                    <div>
                      <p className="text-[#F4EBDD] font-medium">{testimonial.name}</p>
                      {testimonial.role && <p className="text-[#B9AFA3] text-xs">{testimonial.role}</p>}
                    </div>
                  </div>
                </div>
              ))}
          ...
          <div className="mt-16 text-center equestrian-card rounded-lg p-10">
            <h2 className="heading-editorial text-2xl mb-4">
              <span style={{ color: "#F4EBDD" }}>Want to Share Your</span> <span style={{ color: "#D8C7A0", fontStyle: "italic" }}>Experience?</span>
            </h2>
            ...
            <a
              href="/enquiry"
              className="inline-block bg-[#C9A227] hover:bg-[#8A6640] text-white px-8 py-3 rounded-lg font-medium uppercase tracking-wider transition-colors"
            >
              Contact Us
            </a>
          </div>
