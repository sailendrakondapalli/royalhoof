...
export default function EnquiryPage() {
  ...
  const inputClass = 'input-premium w-full rounded-sm px-4 py-3 text-[#F4EBDD] placeholder-[#B9AFA3]/50'
  const labelClass = 'block text-[#C9A227] text-sm font-medium mb-2'
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="heading-editorial text-4xl mb-4">
              <span style={{ color: "#F4EBDD" }}>Enquiry &</span> <span style={{ color: "#D8C7A0", fontStyle: "italic" }}>Free Demo</span>
            </h1>
          ...
          {/* Contact Info */}
          <div className="mt-10 text-center text-[#B9AFA3]">
