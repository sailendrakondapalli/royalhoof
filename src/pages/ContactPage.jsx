...
export default function ContactPage() {
  ...
  const inputClass = `
    w-full rounded-sm px-4 py-3 text-sm text-[#F4EBDD]
    placeholder-[#F4EBDD]/30 focus:outline-none transition-all duration-200
  `
  const inputStyle = {
  ...
  return (
    <>
      ...
      <div style={{ background: "#16080B", minHeight: "100vh" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                {contactInfo.map((item, i) => (
                  <div key={i} className="equestrian-card rounded-sm p-5 flex items-start gap-4" style={{ transform: "none" }}>
                    <div style={{ color: "#C9A227", flexShrink: 0, marginTop: "2px" }}>
                      {item.icon}
                    </div>
                    <div>
                      <p style={{
                      ...
                      {item.href ? (
                        <a href={item.href} target={item.href.startsWith('http') ? "_blank" : undefined}
                          ...
                          onMouseLeave={e => e.currentTarget.style.color = "#F4EBDD"}
                        >
                          {item.value}
                        </a>
                      ) : (
              ...
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                ...
                <div>
                  <label style={{
                    ...
                    Email <span style={{ color: "#B9AFA3", fontWeight: 400 }}>(optional)</span>
                  </label>
                  <input
                    type="email"
                    value={email}
                ...
                <button
                  ...
                  disabled={submitting}
                  style={{
                    background: submitting ? "rgba(216,199,174,0.5)" : "#C9A227",
                    color: "#16080B",
                    border: "none",
                    borderRadius: "4px",
                    padding: "13px 28px",
                  ...
                  onMouseLeave={e => { if (!submitting) e.currentTarget.style.background = "#C9A227" }}
                >
                  {submitting ? (
                    <>
                      <div style={{
                        width: "16px", height: "16px",
                        border: "2px solid #16080B",
