            ...
            {mode === "forgot" ? (
              <motion.div key="forgot" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }}>
                ...
                {resetSent ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <p className="text-[#765334] text-sm mb-4">Enter your email and we'll send you a link to reset your password.</p>
                    <div>
                      <label className="text-xs text-[#765334] mb-1 block font-medium">Email</label>
              ...
              <motion.div key="auth" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }}>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  {mode === "signup" && (
                    <div>
                      <label className="text-xs text-[#765334] mb-1 block font-medium">Full Name</label>
                      <div className="relative">
