...
// bg: #16080B  sidebar: #16080B  card: #16080B  accent: #C9A227  text: #F4EBDD
...
function Sidebar({ pathname, onSignOut, onNavClick, user, pendingCount }) {
  ...
  return (
    <motion.aside
      ...
      style={{ background: "#16080B", borderRight: "1px solid rgba(255,255,255,0.06)" }}
    ...
    >
      ...
      <div style={{ borderBottom: "1px solid rgba(255,255,255,0.06)" }} className="px-5 py-5">
        <Link to="/admin" onClick={onNavClick} className="flex items-center gap-3 select-none">
          ...
          <div>
            <span style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1rem", fontWeight: 700, color: "#F4EBDD", letterSpacing: "0.06em", display: "block" }}>
              ROYALHOOF
            </span>
            <span style={{ fontSize: "0.625rem", letterSpacing: "0.18em", color: "#C9A227", textTransform: "uppercase", display: "block" }}>
              Admin Panel
            </span>
          </div>
        </Link>
          ...
          return (
            <Link
              ...
              style={{
                ...
                color: active ? "#F4EBDD" : "rgba(243,235,221,0.55)",
              }}
              onMouseEnter={e => { if (!active) e.currentTarget.style.background = "rgba(255,255,255,0.05)" }}
              onMouseLeave={e => { if (!active) e.currentTarget.style.background = "transparent" }}
            >
              <Icon size={15} style={{ color: active ? "#C9A227" : "currentColor", flexShrink: 0 }} />
              <span style={{ flex: 1, fontSize: "0.8125rem", fontFamily: "'Inter', sans-serif", fontWeight: active ? 600 : 400 }}>{label}</span>
              {badge && (
                <span style={{ background: "#C9A227", color: "#16080B", fontSize: "0.625rem", fontWeight: 700, padding: "2px 6px", borderRadius: "9999px", minWidth: 18, textAlign: "center" }}>
                  {badge > 99 ? "99+" : badge}
                </span>
              )}
              {active && <ChevronRight size={12} style={{ color: "#C9A227", marginLeft: "auto" }} />}
            </Link>
          )
        })}
      </nav>
      ...
      <div style={{ borderTop: "1px solid rgba(255,255,255,0.06)", padding: "12px" }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            background: "linear-gradient(135deg, #C9A227, #9A8870)",
            display: "flex", alignItems: "center", justifyContent: "center",
            flexShrink: 0, color: "#16080B", fontWeight: 700, fontSize: "0.75rem",
          }}>
            {initials}
          </div>
          <div style={{ flex: 1, minWidth: 0 }}>
            <p style={{ color: "#F4EBDD", fontSize: "0.75rem", fontWeight: 600, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", fontFamily: "'Inter', sans-serif" }}>{displayName}</p>
            <span style={{ fontSize: "0.5625rem", fontWeight: 700, padding: "2px 6px", borderRadius: "9999px", background: "rgba(216,199,174,0.15)", color: "#C9A227", display: "inline-block", letterSpacing: "0.08em" }}>
              ADMIN
            </span>
          </div>
        </div>
...
export default function AdminLayout({ children }) {
  ...
  return (
    <div className="flex h-screen overflow-hidden" style={{ background: "#16080B" }}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="h-14 flex items-center justify-between px-4">
            <div className="flex items-center gap-3">
              <button
                ...
                style={{ color: "#C9A227", background: "none", border: "none", cursor: "pointer", padding: "6px", borderRadius: "4px" }}
                onMouseEnter={e => e.currentTarget.style.background = "rgba(255,255,255,0.06)"}
                onMouseLeave={e => e.currentTarget.style.background = "none"}
              >
                <Menu size={20} />
              </button>
              <span style={{ color: "#F4EBDD", fontSize: "0.875rem", fontWeight: 600, fontFamily: "'Inter', sans-serif" }}
            ...
            <span style={{ fontFamily: "'Cormorant Garamond', serif", color: "#C9A227", fontSize: "1rem", fontWeight: 600, letterSpacing: "0.06em" }}
              className="sm:hidden">
              ROYALHOOF
            </span>
            ...
            <div className="flex items-center gap-2">
                  ...
                  {notifOpen && (
                    ...
                    >
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px 16px", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
                        <span style={{ color: "#F4EBDD", fontSize: "0.875rem", fontWeight: 600 }}>Notifications</span>
                        ...
                        {notifications.length === 0
                          ...
                          : notifications.map(n => (
                            <div key={n.id} style={{ display: "flex", alignItems: "flex-start", gap: 12, padding: "12px 16px", borderBottom: "1px solid rgba(255,255,255,0.04)", cursor: "pointer" }}>
                              <AlertTriangle size={13} style={{ color: "#C9A227", marginTop: 2 }} />
                              <div style={{ flex: 1 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <div style={{
                  ...
                  background: "linear-gradient(135deg, #C9A227, #9A8870)",
                  display: "flex", alignItems: "center", justifyContent: "center",
                  color: "#16080B", fontWeight: 700, fontSize: "0.6875rem",
        ...
        <main className="flex-1 overflow-y-auto" style={{ background: "#16080B", padding: "24px" }}>
          {children}
        </main>
      </div>
    </div>
