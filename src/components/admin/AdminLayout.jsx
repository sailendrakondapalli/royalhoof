          ...
          return (
            <Link
              ...
              style={{
                ...
                borderLeft: active ? "2px solid #C5963A" : "2px solid transparent",
                paddingLeft: active ? "10px" : "10px",
                color: active ? "#F5EBD8" : "rgba(243,235,221,0.55)",
              }}
            ...
            >
              ...
              {active && <ChevronRight size={12} style={{ color: "#C5963A", marginLeft: "auto" }} />}
            </Link>
          )
        })}
      </nav>
      ...
      <div style={{ borderTop: "1px solid rgba(255,255,255,0.06)", padding: "12px" }}>
        ...
        <div style={{
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <p style={{ color: "#F5EBD8", fontSize: "0.75rem", fontWeight: 600, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", fontFamily: "'Inter', sans-serif" }}>{displayName}</p>
            <span style={{ fontSize: "0.5625rem", fontWeight: 700, padding: "2px 6px", borderRadius: "9999px", background: "rgba(216,199,174,0.15)", color: "#C5963A", display: "inline-block", letterSpacing: "0.08em" }}>
              ADMIN
            </span>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header style={{
          ...
          <div className="h-14 flex items-center justify-between px-4">
            ...
            <span style={{ fontFamily: "'Cormorant Garamond', serif", color: "#C5963A", fontSize: "1rem", fontWeight: 600, letterSpacing: "0.06em" }}
              className="sm:hidden">
              ROYALHOOF
            </span>
                          ...
                          : notifications.map(n => (
                            <div key={n.id} style={{ display: "flex", alignItems: "flex-start", gap: 12, padding: "12px 16px", borderBottom: "1px solid rgba(8,43,73,0.08)", cursor: "pointer" }}>
                              ...
                              <div style={{ flex: 1 }}>
                                ...
                                <p style={{ color: "#765334", fontSize: "0.6875rem", marginTop: 2 }}>{new Date(n.time).toLocaleTimeString()}</p>
                              </div>
                              <button onClick={() => clearNotification(n.id)} style={{ color: "#765334", background: "none", border: "none", cursor: "pointer" }}>
                                <X size={11} />
                              </button>
                            </div>
                          ))
